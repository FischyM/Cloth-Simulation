...
class Camera
{
  Camera()  // -57.212227, -97.27954, 80.814766 ]11.18154-0.7174731
  {
    position      = new PVector( -57, -97, 80 ); // initial position
    theta         = 11; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.7174; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
